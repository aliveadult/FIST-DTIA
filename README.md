...
![FIST-DTIA Architecture](ttps://github.com/user-attachments/files/24727286/SwinBlock.and.pharmacophore.graph.convolution.combined.with.drug-protein.mixed.attention)
)
